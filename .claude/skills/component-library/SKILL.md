...
**Sin set de marca propio** (existió en `src/components/icons/nora/`, generado con IA — borrado entero 2026-09-12 a pedido explícito del usuario). Todo ícono del sitio usa `lucide-react` directo — no reflotar ese set sin que se pida de nuevo (está en el historial de git).
